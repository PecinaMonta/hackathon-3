    ...
    return (
        <div>
            ...
            <div className="col">
                ...
                <div className="col d-flex mb-5">
                <Link to="https://en.wikipedia.org/wiki/Asia" className="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                ...
                <div className="col d-flex mb-5">
                <Link to="https://en.wikipedia.org/wiki/Africa" className="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
